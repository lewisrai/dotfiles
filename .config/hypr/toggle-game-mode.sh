if hyprctl monitors | head -2 | grep 2560x1600@60; then
    pkexec sh -c 'cpupower frequency-set --governor performance; scxctl switch --sched lavd --mode gaming'
    ...
    pkexec sh -c 'cpupower frequency-set --governor powersaver; scxctl switch --sched lavd --mode powersave'
