...
sudo pacman -S asusctl brightnessctl discord dunst hypridle hyprland hyprlock hyprpaper imv lazygit libreoffice-fresh librewolf mpv ncspot nvim nwg-look obs-studio otf-firamono-nerd proton-vpn-gtk-app rofi-wayland supergfxctl uwsm vpl-gpu-rt v4l2loopback-dkms waybar xdg-desktop-portal-hyprland yazi --needed --noconfirm
